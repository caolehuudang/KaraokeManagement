...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
			...
			httpSecurity.csrf().disable().authorizeRequests()
				.antMatchers("/customer").hasAnyAuthority(Contants.ROLE_ADMIN, Contants.ROLE_CUSTOMER)
				.antMatchers("/authenticate", "/register").permitAll().

				antMatchers("/admin", "/getUserById", "/getAllUser", "/updateUser", "/updateVip", "/addNewCategory",
						"/updateCategory", "/addNewRoom", "/updateRoom", "/addNewItem", "/updateItem", "/pay")
				.hasAuthority(Contants.ROLE_ADMIN).

				antMatchers("/", "/getAllVip", "/findVipById", "/getAllCategory", "/getAllRoom", "/changeStatusRoom",
						"/getAllItem", "/getAllOrders", "/addNewOrder", "/updateOrder", "/getOrderByName",
						"/getTotalMonth", "/getAllOrderItem", "/addNewOrderItem", "/updateOrderItem",
